...
<code>apt update && apt upgrade -y && apt install sudo git -y && sudo rm -rf WhaticketWorkflow-main && sudo git clone https://github.com/andrew890074/WhaticketWorkflow.git && cd WhaticketWorkflow-main && sudo chmod +x ./automatizaai && ./automatizaai</code><br />
&nbsp;</p>
